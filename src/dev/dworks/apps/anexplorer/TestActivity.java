    ...
    public void onCreate(Bundle icicle) {
        ...
        button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
            	...
            	intent.setAction(IntentUtils.ACTION_OPEN_DOCUMENT);
        ...
        button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
            	...
            	//Intent intent = new Intent(TestActivity.this, DocumentsActivity.class);
            	intent.setAction(IntentUtils.ACTION_CREATE_DOCUMENT);
                intent.addCategory(Intent.CATEGORY_OPENABLE);
        ...
        button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
            	//Intent intent = new Intent(DocumentsContract.ACTION_MANAGE_ROOT);
                Intent intent = new Intent(TestActivity.this, DocumentsActivity.class);
                intent.setAction(DocumentsContract.ACTION_MANAGE_ROOT);
                intent.addCategory(Intent.CATEGORY_OPENABLE);
                intent.setType("*/*");
                if (localOnly.isChecked()) {
                    intent.putExtra(Intent.EXTRA_LOCAL_ONLY, true);
