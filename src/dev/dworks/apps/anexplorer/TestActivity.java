    ...
    public void onCreate(Bundle icicle) {
        ...
        button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (multiple.isChecked()) {
                    intent.putExtra(IntentUtils.EXTRA_ALLOW_MULTIPLE, true);
                }
                if (localOnly.isChecked()) {
                    intent.putExtra(IntentUtils.EXTRA_LOCAL_ONLY, true);
                }
        ...
        button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.addCategory(Intent.CATEGORY_OPENABLE);
                intent.setType("*/*");
                intent.putExtra(IntentUtils.EXTRA_MIME_TYPES, new String[]{
        ...
        button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(IntentUtils.ACTION_CREATE_DOCUMENT);
                intent.addCategory(Intent.CATEGORY_OPENABLE);
                intent.setType("text/plain");
                intent.putExtra(IntentUtils.EXTRA_TITLE, "foobar.txt");
                if (localOnly.isChecked()) {
                    intent.putExtra(IntentUtils.EXTRA_LOCAL_ONLY, true);
                }
        ...
        button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TestActivity.this, DocumentsActivity.class);
                intent.setAction(IntentUtils.ACTION_GET_CONTENT);
                intent.addCategory(Intent.CATEGORY_OPENABLE);
                intent.setType("*/*");
                if (multiple.isChecked()) {
                    intent.putExtra(IntentUtils.EXTRA_ALLOW_MULTIPLE, true);
